...
namespace Presentation.Management
{
    public partial class WorkOnManager : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            var context = new FUH_COMPANYContext();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            using (var context = new FUH_COMPANYContext())
            {
                var existingEntity = context.TblWorksOns.Find(empSsn, proNum);
        ...
        private void dvgListWorkOn_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
